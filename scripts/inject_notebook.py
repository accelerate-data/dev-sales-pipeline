...
Environment variables required:
  ...
  EPHEMERAL_LAKEHOUSE_ID
  NOTEBOOK_GLOB       — glob pattern to find the notebook (e.g. intents/**/notebook.ipynb)
  HEAD_BRANCH         — feature branch name
  REPO_URL            — GitHub repo clone URL
  GITHUB_APP_ID, GITHUB_INSTALLATION_ID, GITHUB_APP_PEM
  AZURE_KEYVAULT_URL
"""
...
def substitute_parameters_cell(notebook: dict) -> dict:
    ...
    github_pem_secret = os.environ.get("GITHUB_APP_PEM", "")
